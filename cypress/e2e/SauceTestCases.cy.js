...
import SauceDemoLogin from "../PageObjects/SaucePageElements";
...
describe('Sauce Page POM implementation', () => {
    ...
    it('TC 0.1: Check if home page has been visited', () => {
        cy.url()
...
TC 3.8 Verify user is taken to checkout information form page on clicking checkout button
  ...
  */
// Verify that open the cart
//Verify items in the cart
// Verify items in the cart can be deleted or removed
